...
document.addEventListener("DOMContentLoaded", function (e) {
    ...
    let departamentoLogueado = JSON.parse(localStorage.getItem("departamento")) //traigo lo que quedo guardado en el set
    departamento.innerHTML = "Departamento" + departamentoLogueado.departamento
